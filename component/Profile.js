...
const renderSongItem = ({ item }) => (
    <View style={styles.songItem}>
        ...
        <Acon name={"dots-three-vertical"} color={"white"} size={18} />
    </View>
)
    ...
    return (
        <SafeAreaView style={style.container_main}>
            ...
            <View style={{ flex: 0.44, backgroundColor: '#333333', borderBottomRightRadius: 60, borderBottomLeftRadius: 60, width: '100%', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ justifyContent: 'center', alignItems: 'center', height: height * 0.25, marginTop: 15 }} >
                ...
                <Text style={{ fontSize: 14, fontWeight: 400, color: "white", marginBottom: 25 }}>{email}</Text>
            ...
            <View style={{ flex: 0.13, flexDirection: "row", gap: width * 0.3, alignItems: 'center', justifyContent: 'center' }}>
                <View style={{ flexDirection: "column", alignItems: 'center' }}>
                    ...
                    <Text style={{ fontSize: 12, fontWeight: 500, color: "white", marginTop: 7 }}>Add Friends</Text>
                </View>
                <View style={{ flexDirection: "column", alignItems: 'center' }}>
                    <Mcon name='share-outline' color={'white'} size={width * 0.08} />
                    <Text style={{ fontSize: 12, fontWeight: 500, color: "white", marginTop: 7 }}>Share</Text>
                </View>
            </View>
            ...
            <View style={{ flex: 0.33, marginLeft: 10, marginRight: 10, marginTop: 10 }}>
                <Text style={{ fontSize: 20, fontWeight: 600, color: "white" }}>Mostly Played</Text>
                <FlatList
                    data={Mostly}
